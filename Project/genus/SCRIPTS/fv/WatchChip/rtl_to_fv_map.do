...
# Generated on: Wed Nov 22 12:44:03 MST 2023 (Wed Nov 22 19:44:03 UTC 2023)
...
set logfile fv/WatchChip/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/WatchChip -revised fv_map
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  ../HDL/RTL/7seg/Seg7Dsiplay.v ../HDL/RTL/7seg/bcdToSeg7.v ../HDL/RTL/7seg/binToBCD.v ../HDL/RTL/WatchChip/WatchChip.v ../HDL/RTL/backlight/backlight.v ../HDL/RTL/clk_divider/clk_divider.v ../HDL/RTL/digital_clock/digital_clock_time.v ../HDL/RTL/stateController/stateController.v
elaborate_design -golden -root {WatchChip} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/WatchChip/fv_map.v.gz
elaborate_design -revised -root {WatchChip}
...
#add_name_alias fv/WatchChip/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.WatchChip.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.WatchChip.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.WatchChip.rtl.fv_map.rpt

...
# Generated on: Tue Nov 28 17:45:53 MST 2023 (Wed Nov 29 00:45:53 UTC 2023)
...
set logfile logs_Nov28-17:45:40/intermediate2final.lec.log ;# user can modify this name for succeeding runs
...
set_verification_information fv_map_soc_top_mv_db

read_implementation_information fv/soc_top -golden fv_map -revised soc_top_mv
...
read_design -verilog95   -golden -lastmod -noelab fv/soc_top/fv_map.v.gz
elaborate_design -golden -root {soc_top}

read_design -verilog95   -revised -lastmod -noelab outputs_Nov28-17:45:40/soc_top_m.v
elaborate_design -revised -root {soc_top}

#add_name_alias fv/soc_top/fv_map.singlebit.original_name.alias.json.gz -golden
...
#add_name_alias fv/soc_top/soc_top_mv.singlebit.original_name.alias.json.gz -revised
...
write_compared_points noneq.compared_points.soc_top.fv_map.soc_top_mv.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.soc_top.fv_map.soc_top_mv.rpt
}
report_test_vector -noneq > noneq.test_vector.soc_top.fv_map.soc_top_mv.rpt

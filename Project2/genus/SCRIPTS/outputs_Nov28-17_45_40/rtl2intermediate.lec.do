...
# Generated on: Tue Nov 28 17:45:51 MST 2023 (Wed Nov 29 00:45:51 UTC 2023)
...
set logfile logs_Nov28-17:45:40/rtl2intermediate.lec.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/soc_top -revised fv_map
...
#add_name_alias fv/soc_top/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.soc_top.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.soc_top.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.soc_top.rtl.fv_map.rpt
